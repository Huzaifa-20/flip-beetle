        ...
        <div className="w-full flex justify-between items-center px-4 sm:px-6 md:px-8">
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <motion.a
              ...
              className="hidden sm:inline-block px-4 py-2 border-2 rounded-lg riposte text-xs uppercase tracking-wider transition-all duration-300 hover:opacity-80 hover:scale-105"
              style={{
      ...
      <AnimatePresence>
        {isMenuOpen && (
          <>
            ...
            {/* Drawer */}
            <motion.div
              className="fixed right-0 top-0 h-screen w-[85vw] xs:w-[75vw] sm:w-[400px] md:w-[450px] lg:w-[500px] max-w-full z-70 flex flex-col justify-between py-4 sm:py-4 md:py-6 px-5 sm:px-6 md:px-8 transition-colors duration-500"
            ...
            >
              ...
              <button
                onClick={() => setIsMenuOpen(false)}
                className="absolute top-3 sm:top-4 md:top-5 right-5 sm:right-8 md:right-12 text-3xl sm:text-4xl transition-colors duration-300 cursor-pointer hover:scale-110 active:scale-95"
              ...
              {/* Menu Items */}
              <nav className="mt-12 sm:mt-14 md:mt-16">
                <MenuVertical
              ...
              {/* CTA & Social Icons grouped at bottom */}
              <div className="flex flex-col gap-8">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-block px-6 py-3 border-2 rounded-lg riposte text-sm uppercase tracking-wider transition-all duration-300 text-center hover:opacity-80"
                  style={{
