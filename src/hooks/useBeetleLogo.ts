 ...
 * - Returns Flip_Beetle_Dark.png for cream/dark-cream backgrounds
 * - Returns Flip_Beetle_Light.png for green/black backgrounds
 */
export const useBeetleLogo = (): string => {
  ...
  return currentTheme === "cream"
    ? "/images/Flip_Beetle_Dark.png"
    : "/images/Flip_Beetle_Light.png";
};
